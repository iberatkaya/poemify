                            ...
                            <Menu.Item
                                onPress={async () => {
                                    try {
                                        ...
                                        await firestore().collection(usersCollectionId).doc(props.item.author.docid).update({ totalPoems: ctr });
                                    ...
                                    <IconButton
                                        ...
                                        onPress={async () => {
                                            try {
                                                ...
                                                let req2 = await firestore().collection(poemsCollectionId).doc(props.item.docid).update({ likes: poem.likes });
